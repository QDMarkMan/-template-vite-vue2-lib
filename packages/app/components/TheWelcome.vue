...
<template>
  ...
  <WelcomeItem>
    ...
    <a href="https://playwright.dev/" target="_blank" rel="noopener">Playwright</a> and
    <a href="https://playwright.dev/docs/writing-tests" target="_blank" rel="noopener">Playwright Component Testing</a>.
    <br />
